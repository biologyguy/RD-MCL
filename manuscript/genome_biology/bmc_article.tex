...
\subsection{Increasing MCL resolution with BLASTP-free sequence similarity metric}\label{subsec:increasingMclResolutionWithBlastp-freeSequenceSimilarityMetric}
...
"Information entropy is defined as the average amount of information produced by a stochastic source of data." -wikipedia, Entropy(info theory)
...
\subsection{Downstream analyses of sample gene families}
...
\subsection{WNT, TIR-containing, and Caspase sequence data}
